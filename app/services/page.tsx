...
const capabilities = [
  { title: "Software Development", code: "ENGINEER", image: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1400&q=75", alt: "Developer working on a laptop in a real office setting", text: "We build robust, secure and scalable software tailored to your business requirements.", items: ["Custom enterprise apps", "API development", "Legacy modernisation", "SaaS architecture"] },
  ...
  { title: "UI/UX Design", code: "DESIGN", image: "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=1400&q=75", alt: "People discussing user experience work around a table", text: "Research, strategy and interface systems that turn complex tasks into clear experiences.", items: ["User research", "Product strategy", "Prototyping", "Design systems"] },
  { title: "Sales Growth & Digital Consulting", code: "GROWTH", image: "https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=1400&q=75", alt: "Business team meeting to plan growth strategy", sales: true, text: "We build proven sales systems that move inventory, grow revenue and turn marketing into measurable results in 30–90 days.", items: ["Conversion-focused ad strategy", "Funnel and offer optimisation", "Sales team training and audits", "Ecommerce marketplace growth", "30–60–90 day sales roadmap", "Revenue and campaign analytics"] },
];
